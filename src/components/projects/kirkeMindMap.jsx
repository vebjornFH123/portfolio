...
import mockUp from "../../img/mockups/mind-map.png";

import flowLogo from "../../img/logos/react-flow.png";
...
export default function KirkeMindMap() {
  const programs = [
    { link: "", name: "Rreact.js", image: reactLogo },
    { link: "", name: "React-flow", image: flowLogo },
    ...
    <div ref={cont} className={` h-auto pt-10 pb-12 flex flex-col items-center `}>
      <div
        ...
        <p className="text-white lg:text-xl lg:font-light text-center md:text-left font-light text-sm leading-4 sm:mt-0 mt-4 ">
          I undertook a paid project were we developed a simple games to be part of a teaching exercise. With a tight deadline from the client, we
          delivered beyond expectations within a short timeframe.
        </p>
        ...
        <div className="w-full flex flex-row justify-center items-center gap-6 pt-10">
          <a
            href="https://mind-map-nettkonfirmant.onrender.com/"
            target="_blank"
          ...
          <a
            href="https://github.com/vebjornFH123/mind-map-nettkonfirmant"
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-row gap-2 justify-center items-center text-[1rem] font-light text-center text-white bg-black pl-8 pr-8 h-16 border-[#f15c55] border-2 rounded-xl">

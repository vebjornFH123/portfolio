...
export default function ThisPage() {
	...
	return (
		<div ref={cont} className={` h-auto pt-10 pb-12 flex flex-col items-center `}>
			<div
				onClick={goToPage()}
				className="m-auto max-w-[920px] w-[75vw] min-h-[70vh] p-10 lg:pl-28 lg:pr-28 rounded-3xl border-2 border-sky-600 hover:bg-neutral-800 transition-all duration-300 cursor-pointer">
